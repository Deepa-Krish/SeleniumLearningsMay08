...
public class ExcelS3_33DeleteLegalEntity extends ExcelTestngBaseClass {
	  @Test(dataProvider = "fetchData")
	  //(groups = {"Regression"})
	  //(priority = 2)
	 public void excelTestS3_33DeleteLegalEntity(String legalEntityName, String legalEnitytSearch) throws InterruptedException {
